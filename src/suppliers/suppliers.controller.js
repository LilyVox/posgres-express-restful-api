...
module.exports = {
  create: [hasOnlyValidFields, hasRequiredProperties, asyncErrorBoundary(create)],
  update: [asyncErrorBoundary(supplierExists), hasOnlyValidFields, hasRequiredProperties, asyncErrorBoundary(update)],
